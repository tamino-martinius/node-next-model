...
describe('Model', function () {
    ...
    var subject = function () { return CreateModel(); };
    ...
    describe('.unfiltered', function () {
        ...
        withSeededData(function () {
            describe('when testing query results', function () {
                var subject = function () { return CreateModel().unfiltered.all(); };
                _1.it('promises to return all matching items as model instances', function () { return __awaiter(void 0, void 0, void 0, function () {
                    var instances;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
    ...
    describe('.unlimited', function () {
        ...
        withSeededData(function () {
            describe('when testing query results', function () {
                var subject = function () { return CreateModel().unlimited.all(); };
                _1.it('promises to return all matching items as model instances', function () { return __awaiter(void 0, void 0, void 0, function () {
                    var instances;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
    ...
    describe('.unskipped', function () {
        ...
        withSeededData(function () {
            describe('when testing query results', function () {
                var subject = function () { return CreateModel().unskipped.all(); };
                _1.it('promises to return all matching items as model instances', function () { return __awaiter(void 0, void 0, void 0, function () {
                    var instances;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
